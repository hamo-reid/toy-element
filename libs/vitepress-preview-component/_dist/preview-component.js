import { openBlock as a, createElementBlock as C, createElementVNode as i, ref as _, defineComponent as Z, watch as x, createBlock as y, Transition as O, withCtx as F, normalizeClass as u, unref as n, normalizeStyle as q, createVNode as H, toDisplayString as b, createCommentVNode as M, createApp as G, computed as T, onMounted as N, resolveComponent as I, renderSlot as D } from "vue";
const V = (o, e) => {
...
const S = /* @__PURE__ */ V(J, [["render", Q]]), W = {}, X = {
  t: "1661231449868",
  class: "icon",
  viewBox: "0 0 1024 1024",
  version: "1.1",
...
const U = /* @__PURE__ */ V(W, [["render", Y]]), ee = {}, te = {
  viewBox: "0 0 544 560",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
};
function ne(o, e) {
  return a(), C("svg", te, e[0] || (e[0] = [
    i("path", {
...
const E = /* @__PURE__ */ V(ee, [["render", ne]]), k = "vitepress-demo-preview", $ = (o, e, t, c) => {
  let l = e === "" ? `${o}` : `${o}-${e}`;
...
const ie = /* @__PURE__ */ V(oe, [["render", ce]]), le = /* @__PURE__ */ Z({
    ...
    return e({
      ...
      default: F(() => [
        l.value ? (a(), C("div", {
          ...
          style: q({ top: m.value + "px" })
        }, [
          H(ie),
          i("span", null, b(d.content), 1)
        ], 6)) : M("", !0)
      ]),
      _: 1
    }));
...
const A = [], P = {
  open: () => {
    const o = document.createElement("div"), e = G(le, {
      content: "\u590D\u5236\u6210\u529F\uFF01",
      close: () => {
        document.body.removeChild(o), A.pop(), e.unmount();
      }
    }), t = e.mount(o);
    document.body.appendChild(o);
    const c = A.length, l = c === 0 ? 10 : (c + 1) * 10 + c * 42;
    t.setTopHeight(l), t.setVisible(!0), A.push(t);
  }
}, re = ["innerHTML"], ue = ["innerHTML"], Ce = /* @__PURE__ */ Z({
  __name: "AntDesign",
  props: {
    code: {},
    showCode: {},
  ...
  setup(o) {
    const e = o, t = B(), { isCodeFold: c, setCodeFold: l } = z(), { copyContent: v, clickCopy: m } = R(), L = _(decodeURIComponent(e.code)), p = _(decodeURIComponent(e.showCode)), d = _(null), g = () => {
      m(L.value), P.open();
    }, f = T(() => {
      var r;
      ...
      return a(), C("div", {
        ...
        i("section", {
          ...
          i("div", {
            ...
            n(c) ? (a(), y(S, {
              key: 1,
              onClick: h[1] || (h[1] = (j) => n(l)(!1))
            })) : (a(), y(U, {
              key: 0,
              onClick: h[0] || (h[0] = (j) => n(l)(!0))
            })),
            H(E, { onClick: g })
          ], 2)
        ], 2),
...
const ae = ["innerHTML"], _e = /* @__PURE__ */ Z({
  __name: "ElementPlus",
  props: {
    code: {},
    showCode: {},
  ...
  setup(o) {
    const e = o, t = B(), { isCodeFold: c, setCodeFold: l } = z(), { clickCopy: v } = R(), m = _(decodeURIComponent(e.code)), L = _(decodeURIComponent(e.showCode)), p = _(null), d = () => {
      v(m.value), P.open();
    }, g = T(() => {
      var s;
      ...
      return a(), C("div", {
        ...
        i("section", {
          ...
          i("div", {
            ...
            n(c) ? (a(), y(S, {
              key: 1,
              onClick: r[1] || (r[1] = (w) => n(l)(!1))
            })) : (a(), y(U, {
              key: 0,
              onClick: r[0] || (r[0] = (w) => n(l)(!0))
            })),
            H(E, { onClick: d })
          ], 2)
        ], 2),
...
const de = ["innerHTML"], ve = /* @__PURE__ */ Z({
  __name: "NaiveUI",
  props: {
    code: {},
    showCode: {},
...
export {
  Ce as AntDesignContainer,
  _e as ElementPlusContainer,
  ve as NaiveUIContainer
};
